...
MODEL_PATH = 'DataIntelligenceTeam/invoice_clients_CAD.0'
lang = 'eng'
# -----------------------------------
...
header_keys = ['shipper', 'consignee', 'notify', 'incoterms', 'cad','container_type','container_id','seal_number','package_quantity','description','gross_weight','hs_code']
details_keys = []
# -----------------------------------
